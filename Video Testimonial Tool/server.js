...
const multer = require("multer"); // Import the Multer middleware for handling file upload
...
app.post("/upload", upload.single("video"), async (req, res) => {
  ...
  try {
    ...
    const auth = new google.auth.GoogleAuth({
      keyFile: "video-testimonial-423807-6116b88f8d22.json", // Path to the service account key file
    ...
    const fileMetadata = {
      ...
      parents: ["1XwFVIg1wJHgVnJUUh6tb9X3ypEQH9jjT"], // Parent folder ID in Google Drive
    };
    const media = {
